...
const SuccessEditedLinkedCard = () => {
  ...
  return (
    <View className="bg-[#3F7A64] h-[100vh] py-[32px]">
      ...
      <View className="mb-4 h-[100%] bg-white px-[32px] rounded-[24px]">
        ...
        <Pressable
          ...
          onPress={() => {showToast("Card deleted successfully.");navigation.navigate("LinkedCards")}}>
          <Text className="text-white text-[16px] font-bold">{i18n.t("done")}</Text>
        </Pressable>
      </View>
    </View>
  );
...
export default SuccessEditedLinkedCard;
